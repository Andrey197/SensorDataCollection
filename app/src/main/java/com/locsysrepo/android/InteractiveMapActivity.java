...
public class InteractiveMapActivity extends FragmentActivity
    ...
    protected final static LatLng   STARTING_LAT_LONG = new LatLng(44.4340827, 26.04736589999993);
    ...
    private static boolean sensingGps = true;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            ...
            if (isLoggingSensorsContinuously) {
                mService.enableSensorDataLogging(isLoggingSensorsContinuously, sensingAcc, sensingMagn, sensingGyro, sensingWifi, sensingGps);
            }
    ...
    private void showOptionsDialog() {
        ...
        final CheckBox ckb_gps = (CheckBox) view.findViewById(R.id.checkBox_gps);
    ...
    private void instructServiceContinuousSensing() {
        if (!isBoundToService)
            ...
            mService.enableSensorDataLogging(isLoggingSensorsContinuously, sensingAcc, sensingMagn,
                    sensingGyro, sensingWifi, sensingGps);
    }
